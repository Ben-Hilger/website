...
const gitHubSVG = (
  <button
  onClick={() => {window.open("https://github.com/Ben-Hilger", "_blank")}}
  type="button"
  data-te-ripple-init
...
const linkedInSVG = (
  <button
  onClick={() => {window.open("https://www.linkedin.com/in/benjaminhilger/", "_blank")}}
  type="button"
  data-te-ripple-init
  data-te-ripple-color="light"
...
const youtubeSVG = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-7 w-7 youtube-icon"
    fill="currentColor"
    viewBox="0 0 24 24">
    <path
