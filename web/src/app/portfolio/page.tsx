...
export default function Portfolio() {
    ...
    const items: CardInfo[] = [
        ...
        new CardInfo(4, "Frontend Masters", "Repository where I host the materials I use in different front-end master courses while learning and reinforcing my knowledge", "https://github.com/Ben-Hilger/frontend-masters"),
        ...
        new CardInfo(6, "GitHub", "There's a bunch of more small projects I've completed and have hosted on my Github Page. Feel free to take a look!", "https://github.com/Ben-Hilger/"),
   ];
