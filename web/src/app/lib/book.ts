...
export const books: Book[] = [
    ...
    new Book(15, "/atomic_habits.jpg", "Atomic Habits", BookState.Read),
    ...
    new Book(24, "/ghost_town_living.jpg", "Ghost Town Living", BookState.Reading),
    new Book(25, "/breaking_free_from_broke.jpg", "Breaking Free From Broke", BookState.Read),
